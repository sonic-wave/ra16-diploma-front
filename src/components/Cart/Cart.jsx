...
import { clearCartList, removeCartItem } from "../../redux/slices/cartSlice";
...
export const Cart = () => {
  ...
  const combinedCartList = cartList.reduce((acc, item) => {
    const existingItem = acc.find(
      (accItem) => accItem.id === item.id && accItem.size === item.size,
    );
    if (existingItem) {
      existingItem.counter += item.counter;
